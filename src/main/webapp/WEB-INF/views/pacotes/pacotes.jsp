...
<jsp:include page="../commons/navbar.jsp"/>
		...
		<div class="container-fluid">
			...
			<div class="row div-pesquisa">
				<div class="col-xs-8 col-xs-offset-2 text-center">
					<form method="post" action="pesquisarPacote">
		  	...
		  	<div class="container-fluid">
				<c:forEach var="pacote" items="${pacotes}">
					<div class="row pacote-row">
						<div class="col-md-3">
							<div id="pacote${pacote.id}" class="panel pacote" onclick="verpacote(${pacote.id})">
        ...
        <c:forEach var="pacote" items="${pacotes}">
        	<div id="form-atualizar-pacote${pacote.id}" class="escondido" title="Atualizar pacote">
	            <form method="post" action="atualizarPacote" class="form-group" enctype="multipart/form-data">
	                ...
	                Canais: 
	                <input type="hidden" id="atualizar_pacote_canais${pacote.id}" name="canais" class="form-control" placeholder="Lista de canais" readonly required>
	                <button type="button" class="btn-block btn-white form-control info" onclick="mostraTelaDeSelecaoDeCanais('atualizar_canais_selecionados${pacote.id}','atualizar_pacote_canais${pacote.id}')">Selecionar canais</button>
